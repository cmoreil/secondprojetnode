    ...
    render() {
        return (
            <div className="Carteluser">
                <div>
                <svg color="yellow" class="bi bi-people" width="3em" height="3em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <h3 className="Titre">Derniers inscrits !</h3>
                {this.state.users.map(user => (
                <ul key= {user.username}> {user.username}
                <div>
                <svg class="bi bi-lightning" color="yellow" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
